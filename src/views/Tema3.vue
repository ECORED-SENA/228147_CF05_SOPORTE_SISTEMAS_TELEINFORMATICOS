  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-10.col-lg-5.mb-4.mb-lg-0
        figure
          img(src='@/assets/curso/temas/tema3/img2.svg', alt='', style="width: 390px").m-auto
      .col-lg-7
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-10.col-lg-4
        figure
          img(src='@/assets/curso/temas/tema3/img3.svg', alt='', style="width: 400px").m-auto
    .row.justify-content-center.align-items-center.mb-5
    ...
    .row.justify-content-center.align-items-center
      .col-10.col-lg-3.mb-4.mb-lg-0
        figure
          img(src='@/assets/curso/temas/tema3/img5.svg', alt='', style="width: 400px").m-auto
      .col-lg-9
        ...
        .p-4.bg-c1
          .row.justify-content-center
            .col-lg-10
              ...
              figure
                img(src='@/assets/curso/temas/tema3/img6.svg', alt='Figura que representa el rendimiento para una prueba de FTP, el cual se divide en la parte a y b.').m-auto
    ...
    .row.justify-content-center.align-items-center
      .col-6.col-lg-2.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema3/img7.svg', alt='', style="width: 400px").m-auto
    ...
    .row.justify-content-center.align-items-center.mb-5
      .col-6.col-lg-2.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema3/img14.svg', alt='', style="width: 400px").m-auto
      .col-lg-8(data-aos="fade-left")
        .tarjeta-azul2.p-4
          p.mb-0 
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-10.col-lg-4
        figure
          img(src='@/assets/curso/temas/tema3/img16.svg', alt='', style="width: 400px").m-auto
    .row.justify-content-center.align-items-center
      .col-10.col-lg-4.d-none.d-lg-block
        figure
          img(src='@/assets/curso/temas/tema3/img17.svg', alt='', style="width: 400px").m-auto
      .col-lg-8
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-10.col-lg-4
        figure
          img(src='@/assets/curso/temas/tema3/img19.svg', alt='', style="width: 400px").m-auto
    .caja-titulos-tercer-nivel.mb-5(data-aos="fade-right")
      .col-lg-auto
        figure
          img(src="@/assets/curso/temas/tema1/img3.png" style="max-width: 60px").m-auto
    ...
    .row.justify-content-center.align-items-center.mb-4
      .col-6.col-lg-2.mb-4.mb-lg-0(data-aos="fade-right")
        figure
          img(src='@/assets/curso/temas/tema3/img20.svg', alt='', style="width: 400px").m-auto
      .col-lg-8(data-aos="fade-left")
        .tarjeta-azul2.p-4
          p.mb-0 
    ...
    .row.justify-content-center.align-items-center.mb-5
      ...
      .col-10.col-lg-4
        figure
          img(src='@/assets/curso/temas/tema3/img21.svg', alt='', style="width: 400px").m-auto
    .caja-titulos-tercer-nivel.mb-5(data-aos="fade-right")
      .col-lg-auto
        figure
          img(src="@/assets/curso/temas/tema1/img3.png" style="max-width: 60px").m-auto
            ...
            .tarjeta.tarjeta--blanca.p-5
              SlyderA(tipo="b")
                .row.justify-content-center.align-items-center
                  ...
                  .col-lg-5
                    figure
                      img(src='@/assets/curso/temas/tema3/img23.svg', alt='', style="width: 400px").m-auto
                .row.justify-content-center.align-items-center
                  .col-lg-6.mb-4.mb-lg-0
                  ...
                  .col-lg-5
                    figure
                      img(src='@/assets/curso/temas/tema3/img24.svg', alt='', style="width: 400px").m-auto
                .row.justify-content-center.align-items-center
                  .col-lg-6.mb-4.mb-lg-0
                  ...
                  .col-lg-5
                    figure
                      img(src='@/assets/curso/temas/tema3/img25.svg', alt='', style="width: 400px").m-auto
    .row.justify-content-center.align-items-center
